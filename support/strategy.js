...
class HintingStrategy {
	constructor() {
		...
		this.POPULATION_LIMIT = 48;
		this.EVOLUTION_STAGES = 64;
		this.MUTANT_PROBABLITY = 0.05;
		this.STEADY_STAGES_X = 4;
		this.STEADY_STAGES_MAX = 20;
		this.CANONICAL_STEM_WIDTH_LIMIT_X = 1.375;
		this.COEFF_A_MULTIPLIER = 1 / 2;
		...
		this.STROKE_SEGMENTS_MIN_OVERLAP = 0.5;
